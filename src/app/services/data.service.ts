...
export class DataService {
    ...
    getDataFromMysql() {
        ...
        let sqlQ = " select count(*) as conteggio, DATE_FORMAT(tel_data, '%d-%m-%Y') as data_telefonata from tel_telefonate ";
        sqlQ = sqlQ + " where tel_chiamato = '4607'  ";
        sqlQ = sqlQ + " AND    tel_data BETWEEN CAST('2018-01-01' AS DATE) AND CAST('2018-12-31' AS DATE) ";
    ...
    getDataFromMysqlMese() {
        ...
        let sqlQ = " select count(*) as conteggio, DATE_FORMAT(tel_data, '%Y-%m') as data_telefonata from tel_telefonate ";
        sqlQ = sqlQ + " where tel_chiamato = '4607'  ";
        sqlQ = sqlQ + " AND    tel_data BETWEEN CAST('2018-01-01' AS DATE) AND CAST('2018-12-31' AS DATE) ";
        sqlQ = sqlQ + " GROUP BY  MONTH(tel_data) ";
    ...
    getDataFromMysqlSettimana() {
        ...
        let sqlQ = " select count(*) as conteggio, " ;
        sqlQ = sqlQ + "  YEARWEEK(tel_data) as data_telefonata,  " ;
        sqlQ = sqlQ + "  @T1 := DATE_FORMAT(STR_TO_DATE(CONCAT(YEARWEEK(tel_data),' Monday'), '%x%v %W') , '%d-%m-%Y') as da_gg,  " ;
        sqlQ = sqlQ + "  @T2 := DATE_FORMAT(DATE_ADD( STR_TO_DATE(CONCAT(YEARWEEK(tel_data),' Monday'), '%x%v %W') , INTERVAL 6 DAY  ), '%d-%m-%Y') as a_gg,  " ;
        sqlQ = sqlQ + "  CONCAT( 'Dal ', @T1, ' al ', @T2 ) as periodo  " ;
        sqlQ = sqlQ + "  from tel_telefonate ";
        sqlQ = sqlQ + "  where tel_chiamato = '4607'  ";
        sqlQ = sqlQ + "  AND    tel_data BETWEEN CAST('2018-01-01' AS DATE) AND CAST('2018-12-31' AS DATE) ";
        sqlQ = sqlQ + "  GROUP BY data_telefonata ";
