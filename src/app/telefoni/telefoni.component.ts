...
@Component({
    templateUrl: require('./telefoni.component.html'),
})

// Component class
export class TelefoniComponent implements OnInit, OnDestroy {
    ...
    public chartDataMese: any;
    public chartDataSettimana: any;
    ...
    reloadData() {
        ...
        this._dataService.getDataFromMysql().
        then(function(dataList) {
            ...
            Object.keys(dataList).forEach(function(key) {
                ...
                chart1.labels.push(dataList[key].data_telefonata);
                dataset.data.push(dataList[key].conteggio);
            });

            chart1.datasets.push(dataset);
            self.chartData = chart1;
        }).catch(function(error) {
            console.log(error);
        });

        this._dataService.getDataFromMysqlMese().
        then(function(dataList) {
            console.log('----------------------------------------------');
            console.log(dataList)
            ...
            chart1.datasets.push(dataset);
            self.chartDataMese = chart1;
        }).catch(function(error) {
            console.log(error);
        });

        this._dataService.getDataFromMysqlSettimana().
        then(function(dataList) {
            console.log('----------------------------------------------');
            console.log(dataList)
            ...
            Object.keys(dataList).forEach(function(key) {
                console.log(key, dataList[key]);
                chart1.labels.push(dataList[key].periodo);
                dataset.data.push(dataList[key].conteggio);
            });

            chart1.datasets.push(dataset);
            self.chartDataSettimana = chart1;
        }).catch(function(error) {
            console.log(error);
        });
